...
By using the AutoObsessions.com web site ("Service"), or any services of <?php ao::eName();?>, Inc ("<?php ao::eName();?>"), you are agreeing to be bound by the following terms and conditions ("Terms of Service").
<br>
...
<br>
Please note, accessing any <?php ao::eName();?> service in your capacity as a government entity, there are special terms that may apply to you. Please see Section G.17, below, for more details.
<br>
If <?php ao::eName();?> makes material changes to these Terms, you will be notified by email or by posting a notice on our site before the changes are effective. Any new features that augment or enhance the current Service, including the release of new tools and resources, shall be subject to the Terms of Service. Continued use of the Service after any such changes shall constitute your consent to such changes. You can review the most current version of the <a href=''>Terms of Service</a>
<br>
Violation of any of the terms below will result in the termination of your Account. While <?php ao::eName();?> prohibits such conduct and Content on the Service, you understand and agree that <?php ao::eName();?> cannot be responsible for the Content posted on the Service and you nonetheless may be exposed to such materials. You agree to use the Service at your own risk.
...
<?php ao::eName();?> shall notify you about significant changes in the treatment of personal information by sending a notice to the primary email address specified in your <?php ao::eName();?> account.
